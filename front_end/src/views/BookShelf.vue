<template>
  <div style="background-color: #f7f6f2;height: 100%;width: 100%">
  <div style="margin: 0 13% 0 13%;padding-top: 40px;background-color: #c45656">
<!--    导航-->
    <div style="float:left;width: 200px;">
      <ul style="padding: 0;margin: 0;list-style-type: none">
        <li style="padding: 10px 0 10px 30px;margin: 0;background-color: #529b2e" >
            <span style="background-color: #c0c4cc">
              <router-link to="/bookshelf">书架详情</router-link>
            </span>
        </li>
        <li style="padding: 10px 0 10px 30px;margin-top: 10px;background-color: #529b2e" >
            <span style="background-color: #c0c4cc">
...
<!--    书架 书本详情-->
        <div style="display: inline-block;background-color: #529b2e;margin-top: 20px">
